...
## Project Structure
    ...
    ├── fj_gifting_senders_36119  # Django project configurations
...
1. Clone this repo and `cd fj_gifting_senders_36119`
...
2. Clone this repo and `cd fj_gifting_senders_36119`
